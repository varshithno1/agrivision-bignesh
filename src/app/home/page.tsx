...
const translations = {
  ...
  es: {
    ...
    pageDescription:
      "अपने बगीचे की योजना बनाने के लिए एक मौसम और फसलों का चयन करें",
                  ...
                  {seasons.map((season) => (
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        {season.icon}
                        <span>
                          {t[season.name as keyof typeof t] as string}
                        </span>
                      </div>
                    </Label>
                  ))}
              ...
              >
                <Alert className="mb-6">
                  ...
                  <AlertDescription>
                    <>
                      {
                        t[
                          `${selectedSeason}Description` as keyof typeof t
                        ] as string
                      }
                    </>
                  </AlertDescription>
                ...
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-xl font-semibold">
                    {t[selectedSeason as keyof typeof t] as string} {t.crops}
                  </h3>
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              ...
                              >
                                {t[crop.difficulty as keyof typeof t] as string}
                              </Badge>
                            </TooltipTrigger>
                            <TooltipContent>
                              <p>
        ...
        <CardFooter className="flex justify-between">
          ...
          {selectedCrops.length > 0 && (
            <Link
              href={{
                pathname:
                  crops[selectedSeason as keyof typeof crops].find(
                    (c) => c.name === selectedCrops[0]
                  )?.url || "#",
